...
function run_hangman() { ./ hangman.c "$1" }

#Test Case 1 : Correct usage with a single - word secret
    echo "Test Case 1: Single-word secret" run_hangman "apple"

#Test Case 2 : Correct usage with a multi - word secret(quoted)
    echo "Test Case 2: Multi-word secret" run_hangman "open ai"
...
#Test Case 5 : Valid guess leading to win
      echo "Test Case 5: Valid guess leading to win" run_hangman "hangman"
